	...
	function QuizSceneBottomToolbarUI() {
		_super.call(this);
		this.skinParts = ["bombButton","skipButton"];
	...
	_proto._Group1_i = function () {
		...
		t.y = 0;
		t.layout = this._HorizontalLayout1_i();
		t.elementsContent = [this.bombButton_i(),this._Rect2_i(),this.skipButton_i()];
		return t;
	};
	_proto._HorizontalLayout1_i = function () {
		var t = new eui.HorizontalLayout();
	...
	var QuizFinishedLayerUI$Skin4 = 	(function (_super) {
		...
		function QuizFinishedLayerUI$Skin4() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","btn_evaluation_selected@2x_png"),
		...
		_proto._Image1_i = function () {
			...
			this._Image1 = t;
			t.percentHeight = 100;
			t.source = "btn_evaluation@2x_png";
			t.percentWidth = 100;
			return t;
		};
		_proto.labelDisplay_i = function () {
