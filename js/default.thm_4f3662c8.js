                ...
                generateEUI.skins = {"eui.TextInput":"resource/eui_skins/TextInputSkin.exml"};generateEUI.paths['resource/eui_skins/Common/ImageButtonUI.exml'] = window.ImageButtonUI = (function (_super) {
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/Common/ProgressBarUI.exml'] = window.ProgressBarUI = (function (_super) {
	__extends(ProgressBarUI, _super);
	...
	var _proto = ProgressBarUI.prototype;

	_proto._Image1_i = function () {
		var t = new eui.Image();
		t.percentHeight = 100;
		t.scale9Grid = new egret.Rectangle(1,1,4,4);
		t.source = "img_time_bar@2x_png";
		t.verticalCenter = 0;
		t.percentWidth = 100;
		return t;
	};
	...
	function QuestionLayerUI() {
		_super.call(this);
		this.skinParts = ["categoryLabel","progressLabel","timeLabel","questionLabel","timeProgress"];
		
		this.height = 416;
		this.width = 722;
		this.elementsContent = [this._Image1_i(),this.categoryLabel_i(),this.progressLabel_i(),this.timeLabel_i(),this.questionLabel_i(),this.timeProgress_i()];
	}
	...
	_proto.timeProgress_i = function () {
		var t = new eui.ProgressBar();
		this.timeProgress = t;
		t.horizontalCenter = 0;
		t.skinName = "ProgressBarUI";
		t.top = 90;
		t.value = 0;
		return t;
	};
	...
	function QuizFinishedLayerUI() {
		_super.call(this);
		this.skinParts = ["upButton","downButton","thumbsGroup","tagTitleLabel","leftTagButton","rightTagButton","tagsGroup","continueButton","correctAnswerLabel"];
		
		this.height = 526;
		this.width = 750;
		this.elementsContent = [this.thumbsGroup_i(),this.tagsGroup_i(),this.continueButton_i(),this.correctAnswerLabel_i()];
	}
	...
	_proto.correctAnswerLabel_i = function () {
		var t = new eui.Label();
		this.correctAnswerLabel = t;
		t.horizontalCenter = 0;
		t.scaleX = 1;
		t.scaleY = 1;
		t.text = "正确答案：";
		t.textColor = 0xf13e39;
		t.top = -20;
		t.visible = false;
		t.x = 275;
		t.y = -20;
