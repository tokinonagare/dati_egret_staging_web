                ...
                generateEUI.skins = {"eui.Button":"resource/eui_skins/ButtonSkin.exml","eui.CheckBox":"resource/eui_skins/CheckBoxSkin.exml","eui.HScrollBar":"resource/eui_skins/HScrollBarSkin.exml","eui.HSlider":"resource/eui_skins/HSliderSkin.exml","eui.TextInput":"resource/eui_skins/TextInputSkin.exml","eui.ProgressBar":"resource/eui_skins/ProgressBarSkin.exml","eui.RadioButton":"resource/eui_skins/RadioButtonSkin.exml","eui.Scroller":"resource/eui_skins/ScrollerSkin.exml","eui.ToggleSwitch":"resource/eui_skins/ToggleSwitchSkin.exml","eui.VScrollBar":"resource/eui_skins/VScrollBarSkin.exml","eui.VSlider":"resource/eui_skins/VSliderSkin.exml","eui.ItemRenderer":"resource/eui_skins/ItemRendererSkin.exml"};generateEUI.paths['resource/eui_skins/Common/TransparentLayerUI.exml'] = window.TransparentLayerUI = (function (_super) {
	...
	function NavigationBarUI() {
		...
		this.height = 88;
		this.width = 750;
		this.elementsContent = [this._Rect1_i(),this.leftButton_i(),this.titleLabel_i()];
	}
	...
	var QuizFinishedLayerUI$Skin1 = 	(function (_super) {
		__extends(QuizFinishedLayerUI$Skin1, _super);
		function QuizFinishedLayerUI$Skin1() {
			_super.call(this);
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","btn_good_on@2x_png")
					])
				,
				new eui.State ("disabled",
					[
		...
		var _proto = QuizFinishedLayerUI$Skin1.prototype;
		...
		return QuizFinishedLayerUI$Skin1;
	})(eui.Skin);
	...
	var QuizFinishedLayerUI$Skin2 = 	(function (_super) {
		...
		function QuizFinishedLayerUI$Skin2() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","btn_bad_on@2x_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	function QuizFinishedLayerUI() {
		_super.call(this);
		this.skinParts = ["interestingButton","boringButton","continueButton"];
		
		this.height = 526;
		this.width = 750;
		this.elementsContent = [this._Group1_i(),this.continueButton_i()];
	}
	...
	_proto._Group1_i = function () {
		...
		t.percentWidth = 100;
		t.layout = this._HorizontalLayout1_i();
		t.elementsContent = [this.interestingButton_i(),this.boringButton_i()];
		return t;
	};
	_proto._HorizontalLayout1_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto.interestingButton_i = function () {
		var t = new eui.Button();
		this.interestingButton = t;
		t.label = "";
		t.x = 132;
		t.y = 39;
		t.skinName = QuizFinishedLayerUI$Skin1;
		return t;
	};
	_proto.boringButton_i = function () {
		var t = new eui.Button();
		this.boringButton = t;
		t.label = "";
		t.x = 142;
